	...
	internal static class BCrypt
	{
		...
		internal static class BCryptAlgorithmCache
		{
			private struct Entry
			{
				...
				public Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle Handle { get; private set; }

				public int HashSizeInBytes { get; private set; }

				public unsafe Entry(string hashAlgorithmId, BCryptOpenAlgorithmProviderFlags flags, Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle handle)
				{
					this = default(Entry);
			...
			public static Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle GetCachedBCryptAlgorithmHandle(string hashAlgorithmId, BCryptOpenAlgorithmProviderFlags flags, out int hashSizeInBytes)
			{
				Entry[] array = _cache;
				Entry[] array2 = array;
				...
				Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle phAlgorithm;
		...
		internal unsafe static Internal.NativeCrypto.SafeKeyHandle BCryptImportKey(Internal.NativeCrypto.SafeAlgorithmHandle hAlg, ReadOnlySpan<byte> key)
		{
			...
			Internal.NativeCrypto.SafeKeyHandle hKey;
		...
		private static extern NTSTATUS BCryptImportKey(Internal.NativeCrypto.SafeAlgorithmHandle hAlgorithm, IntPtr hImportKey, string pszBlobType, out Internal.NativeCrypto.SafeKeyHandle hKey, IntPtr pbKeyObject, int cbKeyObject, byte[] pbInput, int cbInput, int dwFlags);

		internal unsafe static int BCryptEncrypt(Internal.NativeCrypto.SafeKeyHandle hKey, ReadOnlySpan<byte> input, byte[] iv, Span<byte> output)
		{
		...
		internal unsafe static int BCryptDecrypt(Internal.NativeCrypto.SafeKeyHandle hKey, ReadOnlySpan<byte> input, byte[] iv, Span<byte> output)
		{
			fixed (byte* pbInput = input)
			{
				fixed (byte* pbOutput = output)
		...
		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		public unsafe static extern NTSTATUS BCryptEncrypt(Internal.NativeCrypto.SafeKeyHandle hKey, byte* pbInput, int cbInput, IntPtr paddingInfo, [In][Out] byte[] pbIV, int cbIV, byte* pbOutput, int cbOutput, out int cbResult, int dwFlags);

		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		public unsafe static extern NTSTATUS BCryptDecrypt(Internal.NativeCrypto.SafeKeyHandle hKey, byte* pbInput, int cbInput, IntPtr paddingInfo, [In][Out] byte[] pbIV, int cbIV, byte* pbOutput, int cbOutput, out int cbResult, int dwFlags);
		...
		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		internal static extern NTSTATUS BCryptOpenAlgorithmProvider(out Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle phAlgorithm, string pszAlgId, string pszImplementation, BCryptOpenAlgorithmProviderFlags dwFlags);

		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		internal static extern NTSTATUS BCryptCloseAlgorithmProvider(IntPtr hAlgorithm, int dwFlags);

		internal static NTSTATUS BCryptCreateHash(Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle hAlgorithm, out Microsoft.Win32.SafeHandles.SafeBCryptHashHandle phHash, IntPtr pbHashObject, int cbHashObject, ReadOnlySpan<byte> secret, int cbSecret, BCryptCreateHashFlags dwFlags)
		{
		...
		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		private static extern NTSTATUS BCryptCreateHash(Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle hAlgorithm, out Microsoft.Win32.SafeHandles.SafeBCryptHashHandle phHash, IntPtr pbHashObject, int cbHashObject, ref byte pbSecret, int cbSecret, BCryptCreateHashFlags dwFlags);

		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		internal static extern NTSTATUS BCryptDestroyHash(IntPtr hHash);

		internal static NTSTATUS BCryptHashData(Microsoft.Win32.SafeHandles.SafeBCryptHashHandle hHash, ReadOnlySpan<byte> pbInput, int cbInput, int dwFlags)
		{
			return BCryptHashData(hHash, ref MemoryMarshal.GetReference(pbInput), cbInput, dwFlags);
		}

		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		private static extern NTSTATUS BCryptHashData(Microsoft.Win32.SafeHandles.SafeBCryptHashHandle hHash, ref byte pbInput, int cbInput, int dwFlags);

		internal static NTSTATUS BCryptFinishHash(Microsoft.Win32.SafeHandles.SafeBCryptHashHandle hHash, Span<byte> pbOutput, int cbOutput, int dwFlags)
		{
			return BCryptFinishHash(hHash, ref MemoryMarshal.GetReference(pbOutput), cbOutput, dwFlags);
		}

		[DllImport("BCrypt.dll", CharSet = CharSet.Unicode)]
		private static extern NTSTATUS BCryptFinishHash(Microsoft.Win32.SafeHandles.SafeBCryptHashHandle hHash, ref byte pbOutput, int cbOutput, int dwFlags);
