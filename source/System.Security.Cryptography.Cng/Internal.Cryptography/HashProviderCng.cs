...
internal sealed class HashProviderCng : Internal.Cryptography.HashProvider
{
	private readonly Microsoft.Win32.SafeHandles.SafeBCryptAlgorithmHandle _hAlgorithm;

	private Microsoft.Win32.SafeHandles.SafeBCryptHashHandle _hHash;
	...
	internal HashProviderCng(string hashAlgId, ReadOnlySpan<byte> key, bool isHmac)
	{
		...
		Microsoft.Win32.SafeHandles.SafeBCryptHashHandle phHash;
	...
	{
		Microsoft.Win32.SafeHandles.SafeBCryptHashHandle hHash = _hHash;
		_hHash = null;
		hHash?.Dispose();
	}
}
