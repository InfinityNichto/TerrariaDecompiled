...
internal abstract class SafeDeleteContext : SafeHandle
{
	...
	protected System.Net.Security.SafeFreeCredentials _EffectiveCredential;
					...
					fixed (byte* ptr4 = inSecBuffers._item1.Token)
					{
						...
						fixed (byte* ptr6 = inSecBuffers._item2.Token)
						{
							...
							fixed (byte* ptr8 = outSecBuffer.token)
							{
								...
								{
									refContext = new System.Net.Security.SafeDeleteSslContext();
								}
								...
								fixed (char* ptr9 = ascii)
								{
									...
									if (inSecBuffers.Count > 1 && span[1].BufferType == System.Net.Security.SecurityBufferType.SECBUFFER_EXTRA && inSecBuffers._item1.Type == System.Net.Security.SecurityBufferType.SECBUFFER_EMPTY)
									{
										...
										span[1].BufferType = System.Net.Security.SecurityBufferType.SECBUFFER_EMPTY;
										span[1].cbBuffer = 0;
										...
										if (span[1].BufferType == System.Net.Security.SecurityBufferType.SECBUFFER_EXTRA)
										{
											result = -2146893032;
										}
									}
	...
	internal unsafe static int AcceptSecurityContext(ref System.Net.Security.SafeFreeCredentials inCredentials, ref System.Net.Security.SafeDeleteSslContext refContext, global::Interop.SspiCli.ContextFlags inFlags, global::Interop.SspiCli.Endianness endianness, System.Net.Security.InputSecurityBuffers inSecBuffers, ref System.Net.Security.SecurityBuffer outSecBuffer, ref global::Interop.SspiCli.ContextFlags outFlags)
	{
		if (inCredentials == null)
		{
			throw new ArgumentNullException("inCredentials");
						...
						fixed (byte* ptr5 = inSecBuffers._item1.Token)
						{
							...
							fixed (byte* ptr7 = inSecBuffers._item2.Token)
							{
								...
								fixed (byte* ptr9 = outSecBuffer.token)
								{
									...
									span[1].cbBuffer = 0;
									span[1].BufferType = System.Net.Security.SecurityBufferType.SECBUFFER_ALERT;
									if ((refContext == null || refContext.IsInvalid) && flag2)
									{
										refContext = new System.Net.Security.SafeDeleteSslContext();
									}
									...
									if (inSecBuffers.Count > 1 && span2[1].BufferType == System.Net.Security.SecurityBufferType.SECBUFFER_EXTRA && inSecBuffers._item1.Type == System.Net.Security.SecurityBufferType.SECBUFFER_EMPTY)
									{
										...
										span2[1].BufferType = System.Net.Security.SecurityBufferType.SECBUFFER_EMPTY;
										span2[1].cbBuffer = 0;
										span[0].cbBuffer = 0;
										...
										if (span2[1].BufferType == System.Net.Security.SecurityBufferType.SECBUFFER_EXTRA)
										{
											result = -2146893032;
										}
									}
	...
	internal unsafe static int CompleteAuthToken(ref System.Net.Security.SafeDeleteSslContext refContext, in System.Net.Security.SecurityBuffer inSecBuffer)
	{
