...
{
	internal static (HeaderDescriptor descriptor, string value)[] HeaderLookup { get; } = new(HeaderDescriptor, string)[99]
	{
		...
		(new HeaderDescriptor(KnownHeaders.Cookie), ""),
		...
		(new HeaderDescriptor(KnownHeaders.ContentType), "text/html; charset=utf-8"),
		(new HeaderDescriptor(KnownHeaders.ContentType), "text/plain"),
		(new HeaderDescriptor(KnownHeaders.ContentType), "text/plain;charset=utf-8"),
